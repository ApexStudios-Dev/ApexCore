package dev.apexstudios.apexcore.neoforge.common.data.provider;
...
public final class LanguageProviderImpl implements BaseProvider, LanguageProvider {
    public static final ProviderType<LanguageProvider> PROVIDER_TYPE = ProviderType.register(ApexCoreXplat.identifier("language"), LanguageProviderImpl::new);

package dev.apexstudios.apexcore.neoforge.common.seat;

import dev.apexstudios.apexcore.neoforge.api.block.Seat;
...
public interface SeatSetup {
    DeferredEntity<SeatEntity> ENTITY = ApexCoreXplat.REGISTREE.registerEntity("seat", SeatEntity::new, MobCategory.MISC, builder -> builder.sized(1F, 1F).noLootTable());

...
import dev.apexstudios.apexcore.neoforge.api.data.provider.datamap.AdvancedDataMapBuilder;
...
public final class DataMapProviderImpl implements BaseProvider, DataMapProvider {
    public static final ProviderType<DataMapProvider> PROVIDER_TYPE = ProviderType.register(ApexCoreXplat.identifier("data_map"), DataMapProviderImpl::new);

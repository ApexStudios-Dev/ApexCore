...
public final class EmptyLevelEntityGetter<T extends EntityAccess> implements LevelEntityGetter<T> {
    private static final LevelEntityGetter<?> EMPTY = new EmptyLevelEntityGetter<>();

    private EmptyLevelEntityGetter() {
    ...
    public static <T extends EntityAccess> LevelEntityGetter<T> empty() {

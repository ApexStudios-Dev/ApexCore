...
public final class PlacementPreviewRegistry {
    ...
    private static final ContextKey<State<?>> KEY = new ContextKey<>(ApexCore.identifier("render_state"));
    public static final Identifier DEBUG_KEY = ApexCore.identifier("force_render");
